...
if (empty($_GET["token"])) {
  ...
  $rand = md5(rand());
  setcookie("mejs_<?= $argv[3] ?>_token", $rand);
...
setcookie("mejs_<?= $argv[3] ?>_token", "", time() - 3600);
